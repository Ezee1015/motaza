...
#define RECORD_TEMP_FILENAME "Motaza_video_bytes"
...
#define CLIPBOARD_TEMP_FILENAME "motaza_clipboard"
...
class Motaza : public QWidget
{
  Q_OBJECT

  public:
    explicit Motaza(QWidget *parent = 0);
    ~Motaza();
  ...
  private:
    ...
    void saveStateToFile(); // Create a .motaza file
